...
- [x] Top right corner each media should show an opportunity to open in lightbox, but only when that media is hovered, not all the time
- [x] Ensure all projects width of marquee takes up full space, so there is no wide space at the end -->
